...
async def main():
    async with async_playwright() as p:
        ...
        try:
            ...
            await page.goto("https://www.hackerrank.com/domains/algorithms", wait_until="domcontentloaded")
            await asyncio.sleep(5)
            html = await page.content()
            with open("hackerrank_domains.html", "w", encoding="utf-8") as f:
                f.write(html)
            print("Domains HTML saved.")
